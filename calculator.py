...
button_equal = ttk.Button(window, text="=", command=button_equal, style="TButton", width=15, takefocus=False)
...
button_equal.grid(row=4, column=1, columnspan=2, padx=5, pady=5)
button_clear.grid(row=5, column=0, padx=5, pady=5)
button_backspace.grid(row=5, column=1, columnspan=2, padx=5, pady=5)
